...
| `home/dot_local/share/nredf/shell/pwsh/` | The PowerShell equivalent — `Profile.ps1`, `Sources.ps1`, `Defaults.ps1`, `PSReadLine.ps1`, `Functions.bundle.ps1.tmpl`, and `functions/`. Thin stubs in `home/Documents/PowerShell/` (`Microsoft.PowerShell_profile.ps1`) dot-source this canonical tree. |
